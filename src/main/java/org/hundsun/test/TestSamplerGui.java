...
import org.hundsun.test.TestSampler;

    //新建一个类继承AbstractSamplerGui
public class TestSamplerGui extends AbstractSamplerGui {
    ...
    protected JPanel getContentEncoding() {
        ...
        JLabel contentEncodingLabel = new JLabel("Content-Encoding"); // $NON-NLS-1$
    ...
    public void modifyTestElement(TestElement arg0) {
        ...
        arg0.setProperty(TestSampler.domain, domain.getText());
        arg0.setProperty(TestSampler.port, port.getText());
        arg0.setProperty(TestSampler.contentEncoding, contentEncoding.getText());
        arg0.setProperty(TestSampler.path, path.getText());
        arg0.setProperty(TestSampler.method, method.getText());
        arg0.setProperty(TestSampler.postBodyContent, postBodyContent.getText());
        arg0.setProperty(new BooleanProperty(TestSampler.useKeepAlive, useKeepAlive.isSelected()));
    ...
    public void configure(TestElement element) {
        ...
        domain.setText(element.getPropertyAsString(TestSampler.domain));
        port.setText(element.getPropertyAsString(TestSampler.port));
        contentEncoding.setText(element.getPropertyAsString(TestSampler.contentEncoding));
        path.setText(element.getPropertyAsString(TestSampler.path));
        method.setText("GET");
        postBodyContent.setText(element.getPropertyAsString(TestSampler.postBodyContent));
        useKeepAlive.setSelected(true);
